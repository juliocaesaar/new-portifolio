        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          >
            ...
            <p className="text-lg mb-6 text-gray-700 dark:text-gray-300">
              I'm a versatile Software Engineer with a passion for creating innovative solutions that make a real impact. With a comprehensive skill set covering the entire development spectrum, I bring a holistic approach to every project.
            </p>
            
            <p className="text-lg mb-8 text-gray-700 dark:text-gray-300">
              My journey has taken me through various roles including frontend development, backend architecture, UI/UX design, DevOps engineering, and project management. This diverse experience allows me to understand all aspects of software development and deliver cohesive, high-quality solutions.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <Card>
                <CardContent className="pt-6">
                  <h3 className="font-semibold text-lg mb-4">Industry Experience</h3>
                  <ScrollArea className="h-[200px] pr-4">
                    <ul className="space-y-2">
                      {[
